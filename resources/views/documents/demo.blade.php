            ...
            <div class="signature-box">
                <div>
                 ...
                 <form method="POST" action="{{ route('documents.sign.store', $document->signature_token) }}" class="space-y-5">
                    ...
                    <input type="hidden" name="signature-1" id="signature-input-1">
                    <div style="float: right; padding: 10px;">
                        <button id="clear-1" class="clear-button">Clear Signature</button>
                        <button class="submit-button">Submit Signature</button>
                    </div>
                    </form>
                @else
                ...
                <p class="text-green-700 font-semibold text-lg mb-4">
                        ✅ Document signed on :
                        {{ \Carbon\Carbon::parse($document->signed_at)->format('F j, Y') }}
                    </p>
